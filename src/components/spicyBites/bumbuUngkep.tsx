...
export default function BumbuUngkep() {
  return (
    ...
    >
      {/* 🔹 Bagian utama */}
      <div className="flex flex-col md:flex-row items-start justify-start flex-1 w-full px-8 md:px-8 pt-16 md:pt-20 gap-10">
        {/* Gambar kiri */}
        ...
        >
          ...
          <p className="mb-8 text-[23px] font-[Arial] leading-tight">
          ...
          <div className="mb-5">
            <h3 
            className="font-[900] text-[18px] mb-3"
            style={{
          ...
          <div className="w-full">
            <h3 
            className="font-extrabold text-[18px] mb-3"
            style={{
              textShadow: "0.5px 0 0 currentColor, -0.5px 0 0 currentColor"
            }}
            >Varian :</h3>
      ...
      {/* 🔹 Bagian bawah */}
      <div
        className="w-full grid grid-cols-1 md:grid-cols-[1.3fr_0.8fr_1.3fr] items-center justify-items-center text-center md:text-left mt-20"
        style={{
          color: "#990001",
          minHeight: "200px",
        }}
