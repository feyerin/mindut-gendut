        ...
        <div>
          ...
          <form className="flex items-center mb-6">
            <input
              ...
              className="px-4 py-2 rounded-l-full text-black w-full bg-white" 
            />
            <button
              type="submit"
              className="bg-yellow-400 px-4 py-2 rounded-r-full text-black font-semibold hover:bg-yellow-500 transition"
            >
              Subscribe
            </button>
          </form>
