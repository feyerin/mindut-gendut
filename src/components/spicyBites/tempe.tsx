    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-center lg:justify-start gap-6">
          <img src="/Ikon bahan baku pilihan_Kuning.png" alt="Bahan Baku Pilihan" className="w-16 h-16 object-contain flex-shrink-0" />
          <div>
        ...
        <div className="flex items-center gap-6 justify-center lg:justify-start">
          <img src="/Ikon siap santap_Kuning.png" alt="Produk Siap Santap" className="w-16 h-16 object-contain flex-shrink-0" />
