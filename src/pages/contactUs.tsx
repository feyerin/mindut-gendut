...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "Menu andalan kami adalah Nasi Bakar. Semua menu kami dibuat dari resep warisan keluarga, dimasak dengan bumbu rempah asli Indonesia dan cara tradisional yang menjaga cita rasa khasnya.",
  },
  {
    question: "Apakah semua hidangan di Mindut Gendut Halal?",
    answer:
      "Ya, semua hidangan kami 100% Halal dan Mindut Gendut sudah bersertifikasi Halal.",
  },
  {
    question: "Apakah ada lokasi dine-in?",
    answer:
      'Ya, lokasi dine-in kami berada di Gading Serpong. Anda bisa mencari di Google Maps dengan kata kunci “Nasi Bakar Mindut Gendut".',
  },
  {
  ...
  },
  {
    ...
    answer:
      "Ya, kami menerima pesanan dalam jumlah besar untuk event atau acara.",
  },
];
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-8 px-4 py-8 sm:py-16 sm:px-8 xl:px-40">
            <div className="text-left text-[#990001]">
              ...
              <div className="mt-4 mb-4 text-md md:text-xl">
                ...
                <p>
                  West Pakulonan, Kelapa Dua, Tangerang Regency, Banten 15810
                </p>
